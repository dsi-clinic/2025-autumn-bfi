...
def make_scatter_chart(data: pd.DataFrame, x: str, y: str, 
                       x_label: str, y_label: str, color: str) -> alt.Chart:
    """
...
def create_demographics_comparison_chart(df_1980: pd.DataFrame, 
                                        df_2022: pd.DataFrame,
                                        msa_name: str) -> alt.Chart:
    """
