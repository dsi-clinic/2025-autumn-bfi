"""
MSA Dashboard - Main Application
Orchestrates the dashboard UI and coordinates between modules
"""
import streamlit as st

import config
from loaders import load_all_datasets
from charts import make_colored_reg_chart, make_scatter_chart
from demographics import render_demographics_comparison
...
charts = [make_colored_reg_chart(df, *r) for r in config.RELATIONSHIPS]
